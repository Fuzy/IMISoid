...
public class TimeRulerView extends View {
    ...
    public TimeRulerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TimeRulerView, defStyle,
                0);

        mHeaderWidth = a.getDimensionPixelSize(R.styleable.TimeRulerView_headerWidth, mHeaderWidth);
        mHourHeight = a.getDimensionPixelSize(R.styleable.TimeRulerView_hourHeight, mHourHeight);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < hours; i++) {
            ...
            canvas.drawText(label, 0, label.length(), mHeaderWidth - labelWidth - mLabelPaddingLeft,
